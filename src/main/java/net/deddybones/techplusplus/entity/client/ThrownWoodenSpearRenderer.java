...
public class ThrownWoodenSpearRenderer extends EntityRenderer<ThrownWoodenSpear> {
    public static final ResourceLocation THROWN_WOODEN_SPEAR_LOCATION = modLoc("textures/entity/thrown_wooden_spear.png");
    private final ThrownWoodenSpearModel<ThrownWoodenSpear> model;

    public ThrownWoodenSpearRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
        this.model = new ThrownWoodenSpearModel<>(pContext.bakeLayer(ModModelLayers.THROWN_WOODEN_SPEAR_LAYER));
    }
