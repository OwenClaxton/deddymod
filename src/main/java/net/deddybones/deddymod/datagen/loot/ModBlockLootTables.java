package net.deddybones.deddymod.datagen.loot;

import net.deddybones.deddymod.block.ModBlocks;
import net.deddybones.deddymod.block.custom.CoffeePlantBlock;
import net.deddybones.deddymod.block.custom.FibrosiaCropBlock;
